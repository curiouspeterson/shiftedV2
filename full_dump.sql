...
DROP POLICY IF EXISTS "Users can view own availability" ON "public"."employee_availability";
DROP POLICY IF EXISTS "Users can view own assignments" ON "public"."shift_assignments";
DROP POLICY IF EXISTS "Users can update their own profile" ON "public"."profiles";
DROP POLICY IF EXISTS "Users can update own availability" ON "public"."employee_availability";
DROP POLICY IF EXISTS "Users can update own assignments" ON "public"."shift_assignments";
DROP POLICY IF EXISTS "Users can insert own availability" ON "public"."employee_availability";
DROP POLICY IF EXISTS "Users can delete own availability" ON "public"."employee_availability";
DROP POLICY IF EXISTS "System can create profiles" ON "public"."profiles";
DROP POLICY IF EXISTS "Managers can view all profiles" ON "public"."profiles";
DROP POLICY IF EXISTS "Managers can view all availability" ON "public"."employee_availability";
DROP POLICY IF EXISTS "Managers can update all profiles" ON "public"."profiles";
DROP POLICY IF EXISTS "Managers can manage shift requirements" ON "public"."shift_requirements";
DROP POLICY IF EXISTS "Managers can insert assignments" ON "public"."shift_assignments";
DROP POLICY IF EXISTS "Managers can delete profiles" ON "public"."profiles";
DROP POLICY IF EXISTS "Managers can delete assignments" ON "public"."shift_assignments";
DROP POLICY IF EXISTS "Anyone can view shift requirements" ON "public"."shift_requirements";
ALTER TABLE IF EXISTS ONLY "storage"."s3_multipart_uploads_parts" DROP CONSTRAINT IF EXISTS "s3_multipart_uploads_parts_upload_id_fkey";
ALTER TABLE IF EXISTS ONLY "storage"."s3_multipart_uploads_parts" DROP CONSTRAINT IF EXISTS "s3_multipart_uploads_parts_bucket_id_fkey";
ALTER TABLE IF EXISTS ONLY "storage"."s3_multipart_uploads" DROP CONSTRAINT IF EXISTS "s3_multipart_uploads_bucket_id_fkey";
ALTER TABLE IF EXISTS ONLY "storage"."objects" DROP CONSTRAINT IF EXISTS "objects_bucketId_fkey";
ALTER TABLE IF EXISTS ONLY "public"."shift_assignments" DROP CONSTRAINT IF EXISTS "shift_assignments_shift_requirement_id_fkey";
ALTER TABLE IF EXISTS ONLY "public"."shift_assignments" DROP CONSTRAINT IF EXISTS "shift_assignments_profile_id_fkey";
ALTER TABLE IF EXISTS ONLY "public"."profiles" DROP CONSTRAINT IF EXISTS "profiles_id_fkey";
ALTER TABLE IF EXISTS ONLY "public"."employee_availability" DROP CONSTRAINT IF EXISTS "employee_availability_profile_id_fkey";
...
DROP TRIGGER IF EXISTS "update_shift_requirements_updated_at" ON "public"."shift_requirements";
...
ALTER TABLE IF EXISTS ONLY "public"."shift_assignments" DROP CONSTRAINT IF EXISTS "unique_shift_assignment";
ALTER TABLE IF EXISTS ONLY "public"."shift_requirements" DROP CONSTRAINT IF EXISTS "shift_requirements_pkey";
...
ALTER TABLE IF EXISTS ONLY "public"."employee_availability" DROP CONSTRAINT IF EXISTS "employee_availability_profile_id_day_of_week_key";
ALTER TABLE IF EXISTS ONLY "public"."employee_availability" DROP CONSTRAINT IF EXISTS "employee_availability_pkey";
...
DROP TABLE IF EXISTS "public"."shift_requirements";
DROP TABLE IF EXISTS "public"."shift_assignments";
DROP TABLE IF EXISTS "public"."profiles";
DROP TABLE IF EXISTS "public"."employee_availability";
